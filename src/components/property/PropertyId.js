...
import { ConsultPropertyId } from './ConsultPropertyId';


export const PropertyId = ({history}) => {
    
    const {inmuebleId}=useParams();

    const property=useMemo(() => ConsultPropertyId(inmuebleId),[inmuebleId]);
    localStorage.getItem(inmuebleId);
    ...
    return (
        ...
        {/* <ImagenFondo
            ...
            url='./assets/LASAÑA FONDO.jpg'
            text="Hola"
        
        /> */}
        <div className="row">
            <div className="col-xl-12 __property_contenedor">
                ...
                <div className="row mt-5 mb-5">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item"><b>Barrio</b> { barrio } </li>
                            <li className="list-group-item"><b>Alcobas</b> { alcobas } </li>
                            <li className="list-group-item"><b>Baños</b> { banio } </li>
                            <li className="list-group-item"><b>Tipo Inmueble</b> { tipoInmueble } </li>
                            <li className="list-group-item"><b>Canon Mensual</b> { canon } </li>
                            <li className="list-group-item"><b>Gestion</b> { gestion } </li>
                        </ul>
